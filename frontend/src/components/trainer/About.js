                    ...
                    <div className="card rounded-7 shadow-4-strong h-100">
                      ...
                      <div className="card-body">
                        ...
                        <div>
                          ...
                          >
                            <NavLink
                              to="https://www.facebook.com/profile.php?id=100066912692926"
                          ...
                          >
                            <NavLink
                              to="https://www.instagram.com/i_am_prince067/"
                              className="me-4 text-reset"
                            >
                          ...
                          >
                            <NavLink
                              to="https://www.linkedin.com/in/prince-prajapati-18243b1a0/"
                              className="me-4 text-reset"
                            >
                          ...
                          >
                            <NavLink
                              to="https://github.com/prince8948"
                              className="me-4 text-reset"
                            >
                    ...
                    <div className="card rounded-7 shadow-4-strong h-100">
                      ...
                      <div className="card-body">
                        ...
                        <div>
                          ...
                          >
                            <NavLink
                              to="https://www.facebook.com/profile.php?id=100007619438980"
                              className="me-4 text-reset"
                            >
                              <i className="fab fa-facebook-f" />
                            </NavLink>
                          ...
                          >
                            <NavLink
                              to="https://www.instagram.com/mohit_mishra_1504/"
                              className="me-4 text-reset"
                            >
                              <i className="fab fa-instagram" />
                            </NavLink>
                          ...
                          >
                            <NavLink
                              to="https://www.linkedin.com/in/mohit-mishra-a3a314173/"
                              className="me-4 text-reset"
                            >
                              <i className="fab fa-linkedin" />
                            </NavLink>
                          ...
                          >
                            <NavLink
                              to="https://github.com/mohitgithub1504"
                              className="me-4 text-reset"
                            >
                              <i className="fab fa-github" />
                            </NavLink>
