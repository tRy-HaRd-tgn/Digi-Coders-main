              ...
              <div className="py-5">
                <div className="card-body text-white">
                  <div className="row d-flex align-items-center justify-content-center">
                    ...
                    >
                      <div
                        className="bg-image hover-overlay ripple shadow-4-strong rounded-7"
        ...
        <div className="card">
          <div className="px-3 py-2" style={{ backgroundColor: "#f1f1f1" }}>
            <div className="row d-flex align-items-center">
              <div className="col">
                <h4
                  className="card-title text-uppercase fw-bold mt-2 mx-4"
              ...
              <div className="col-md-4">
                <div className="card">
                  <div className="py-2" style={{ backgroundColor: "#f1f1f1" }}>
                    <h5
                      className="text-uppercase text-center fw-bold mt-2 mx-3"
