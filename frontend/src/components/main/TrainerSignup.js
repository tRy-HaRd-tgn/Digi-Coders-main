...
const TrainerSignup = () => {
  ...
  const uploadFile = (e) => {
    ...
    if (file) {
      trainersignupForm.setFieldValue("avatar", file.name);
    }
  ...
  return (
    <motion.div
      ...
      className="modern-trainer-signup-container"
      style={{
    ...
    >
        ...
        <div className="row justify-content-center align-items-center">
          <div className="col-lg-10">
            <motion.div
              ...
              className="modern-trainer-signup-card"
              style={{
            ...
            >
              <div className="row g-0">
                ...
                >
                  ...
                  >
                    Войдите в свой аккаунт и продолжайте создавать контент!
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  >
                    <NavLink
                      ...
                      onClick={() => {
                        console.log(
                          "Кнопка 'Войти' нажата - переход на /main/trainerlogin"
                        );
                      }}
                    >
                      Войти
                ...
                >
                  ...
                  >
                    ...
                    >
                      Создайте свой аккаунт и начните обучать других
                    </p>
                  </motion.div>
                  ...
                  <form onSubmit={trainersignupForm.handleSubmit}>
                    ...
                    >
                      ...
                      {trainersignupForm.errors.mobile_no && (
                        <motion.span
                          initial={{ opacity: 0, y: -10 }}
                          animate={{ opacity: 1, y: 0 }}
                          style={{
                    ...
                    >
                      ...
                      {trainersignupForm.errors.avatar && (
                        <motion.span
                          initial={{ opacity: 0, y: -10 }}
                          animate={{ opacity: 1, y: 0 }}
                          style={{
      ...
      <style jsx>{`
        ...
        .modern-trainer-signup-container {
